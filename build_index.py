...
def main():
    ...
    # Exactly one of --chunks or --pdf must be provided. The chunks path is
    # preferred because the JSON has already gone through parsing and cleaning,
    # so it is faster and does not require the PDF extraction dependencies.
